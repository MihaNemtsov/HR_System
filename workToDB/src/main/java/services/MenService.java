...
public class MenService {
    ...
    public void saveMen(Mens men) {
        menDao.save(men);
        new MailService().sendMail("hatulmadan144@gmail.com","Save men");
    }

    public void deleteMen(Mens men) {
        menDao.delete(men);
        new MailService().sendMail("hatulmadan144@gmail.com","Delete men with id = " + men.getId());
    }

    public void updateMen(Mens men) {
        menDao.update(men);
        new MailService().sendMail("hatulmadan144@gmail.com","Update men with id = " + men.getId());
